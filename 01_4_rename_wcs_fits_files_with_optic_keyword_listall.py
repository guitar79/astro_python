...
for fullname in fullnames[:]:
    ...
    elif fullname[-8:].lower() == "_wcs.fit" and os.path.isfile('{}'.format(fullname)):
        try :
            print ("Starting...   fullname: {}".format(fullname))
            new_filename = astro_utilities.get_new_filename(fullname)
            new_filename = "{}_wcs.fit".format(new_filename[:-8])
    ...
    elif fullname[-4:].lower() == ".fit" and fullname[-7:-4].lower() != "wcs" \
